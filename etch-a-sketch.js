...
document.documentElement.style.setProperty('--objectHeight', objectHeight + "px");
...
document.documentElement.style.setProperty("--gridHeight", totalGridHeight + 'px');
document.documentElement.style.setProperty("--gridWidth", totalGridWidth + 'px');
